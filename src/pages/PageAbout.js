        ...
        <main>
            <section className="about">
                ...
                <div className="about-us">
                    <p>Welcome to Fresh Flix! This site is a dynamic movie database, created by <span className="tmdb">Kaaren</span>, <span className="tmdb">Elena</span> and <span className="tmdb">Evan</span>, that allows you to discover new movies based on popularity, ratings ans release date.</p>
                    <p>Here you can find out more about the movie's plot, curent rating, release date, and even favorite the movies you want to remember!</p>
